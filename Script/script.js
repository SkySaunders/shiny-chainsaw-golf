...
$(function () {
    const games = [
        ...
        },
        {
            ...
            link1: "https://skysaunders.github.io/animated-sniffle-foxtrot/",
        ...
        },
        {
            ...
            link1: "https://cbuf0rd.github.io/glowing-meme-foxtrot/",
            link2: "https://cbuf0rd.github.io/glowing-giggle-echo-lab/",
            author: "Candice Buford",
        },
        {
            title: "charlie, delta",
            link1: "https://hrantgartley.github.io/didactic-waffle-delta/",
            link2: "https://hrantgartley.github.io/jubilant-bassoon-echo/",
            author: "Grant Hartley",
        },
        {
            title: "probable-charlie, turbo-delta",
            link1: "https://quantumcoder-242.github.io/probable-charlie/",
            link2: "https://quantumcoder-242.github.io/turbo-delta/",
            author: "Navraj_Singh",
        },
        {
            title: "psychic-delta, charlie-lab",
            link1: "https://akashdeepsingh0047.github.io/psychic-delta/",
            link2: "https://akashdeepsingh0047.github.io/Chrlie-lab-By-Akashdeep/",
            author: "AkashdeepSingh0047",
        },
        {
            title: "CHARLIE, delta",
            link1: "https://aalluhaybi1.github.io/CHARLIE_LAB/",
            link2: "https://aalluhaybi1.github.io/DELTA-LAB/",
            author: "Ayman Alluhaybi",
        },
        {
            title: "Charlie, Delta",
            link1: "https://bbolton1.github.io/CIS376-Charlie-Brayden/",
            link2: "https://bbolton1.github.io/delta-lab-brayden/",
            author: "Brayden Bolton",
        },
        {
            title: "charlie-lab, delta-lab",
            link1: "https://mohammedalrasheidi.github.io/Charlie/",
            link2: "https://mohammedalrasheidi.github.io/Delta-lab/",
            author: "Mohammed Alrasheidi",
        },
        {
            title: "charlie-lab-cis376, delta-lab-cis376",
            link1: "https://babayaga1013.github.io/charlie-lab-cis376/",
            link2: "https://babayaga1013.github.io/reimagined-couscous--delta/",
    ...
    $.each(games, function (index, item) {
        ...
        console.log("Game URL1: " + item.link1)
        console.log("Game URL1: " + item.link2)
        console.log("Game Author: " + item.author)

        // create a brand new HTML element JUST with code

        const el = `<div class='card text-center mx-auto bg-dark blue' > \
            <button class='cardOpen2 btn btn-outline-info'>Games: ${item.title} </button> \
             <div class='cardHide'> \
                 <br> \
                 <a href="${item.link1}" target="_blank" class="link-info btn btn-primary">GAME LINK1</a> \
                 <a href="${item.link2}" target="_blank" class="link-info btn btn-primary">GAME LINK2</a> \
        ...
        $(".nav-dropdown").append(
            $(
                `<li><a href="#!" class="dropdown-item"> ${item.author} </a></li>`
            )
        )
    })
})
